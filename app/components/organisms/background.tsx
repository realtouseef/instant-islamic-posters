...
export const Background = ({ children, ref }: { children: React.ReactNode; ref: RefObject<HTMLDivElement | null>; }) => {
  ...
  return (
    <div ref={ref} className="relative h-full w-full rounded-2xl overflow-hidden">
    ...
    {backgroundType === "gradient" && (
      <div className="absolute inset-0 rounded-2xl transition-all duration-300" style={{ background: gradient }} />
    )}
